...
//   );
//   const [selectedColor, setSelectedColor] = useState('#6b6b47'); // Default color
...
//       color: selectedColor,
//       size: selectedSize,
//       price: 260, // Placeholder, can be dynamic
...
const ProductDetail = () => {
  ...
  const handleAddToCart = () => {
    ...
    addToCart(productDetails);  // Add to cart using context
